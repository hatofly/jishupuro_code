...
def _multiarray2numpy(pytype, dtype, multiarray):
    ...
    return np.array(multiarray.data).reshape(dims).astype(dtype)

numpy2i32multi = partial(_numpy2multiarray, Int32MultiArray)
i32multi2numpy = partial(_multiarray2numpy, int, np.int32)
